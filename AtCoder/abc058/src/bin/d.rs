...
fn main() {
        ...
        let x_sum = {
                ...
                for i in 0..n {
                        res += Mint::new((x_list[i] + MOD as isize) as usize)
                                * (Mint::new(i) - (Mint::new(n) - Mint::new(i) - Mint::new(1)));
                }
        ...
        let y_sum = {
                let mut res = Mint::new(0);
                for i in 0..m {
                        res += Mint::new((y_list[i] + MOD as isize) as usize)
                                * (Mint::new(i) - (Mint::new(m) - Mint::new(i) - Mint::new(1)));
                }

                res
        };

        let ans = (x_sum * y_sum).a;
